...
exports.getExamList = (req, res) => {
  conn.query(
    'SELECT count(*) as current_count, E.id, E.title, E.created_at, E.question_num, E.school, E.grade, E.writer FROM Problem as P join Exam as E on P.exam_id = E.id Group by E.id;',
    (err, result) => {
      if (err) throw err;
      return res.status(200).json({
        result
